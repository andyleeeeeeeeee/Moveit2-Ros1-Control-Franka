...
int main(int argc, char** argv) {
  ...
  // Client for triggering gripper action
  actionlib::SimpleActionClient<control_msgs::GripperCommandAction> gripperClient_("/franka_gripper/gripper_action", true);
  franka_gripper::gripperClient = &gripperClient_;
